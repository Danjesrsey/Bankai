...
module.exports = {
	...
	langs: {
		...
		en: {
			missingMessage: "saisir le message que vous souhaitez envoyer à tous les groupes...❤️",
			notification: "📨Notification de l'administrateur du bot à tous les groupes de discussion 📨\n ❤️(Pour répondre, utilisez la cmd『!callad』)❤️",
			sendingNotification: "❤️Envoie des notifications de l'administrateur du bot à %1 groupes de discussion❤️",
